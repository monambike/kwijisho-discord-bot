...
namespace KWiJisho.Commands.Prefix
{
    ...
    public partial class PrefixCommandManager
    {
        ...
        public class PrefixBasic : BaseCommandModule
        {
            ...
            public async Task SendRandomAnimatedEmojiAsync(CommandContext commandContext) => await CommandBasic.CommandRandomAnimatedEmojiAsync(commandContext.Channel);
            ...
            public async Task SendRandomMemeEmojiAsync(CommandContext commandContext) => await CommandBasic.CommandRandomAnimatedMemeEmojiAsync(commandContext.Channel);
            ...
            public async Task SendRandomPartyEmojiAsync(CommandContext commandContext) => await CommandBasic.CommandRandomAnimatedPartyEmojiAsync(commandContext.Channel);
        }
    }
}
