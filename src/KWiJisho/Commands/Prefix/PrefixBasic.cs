...
namespace KWiJisho.Commands.Prefix
{
    ...
    public partial class PrefixCommandManager
    {
        ...
        public class PrefixBasic : BaseCommandModule
        {
            ...
            public async Task SendRandomAnimatedEmojiAsync(CommandContext commandContext) => await KWiJisho.Commands.CommandBasic.CommandRandomAnimatedEmojiAsync(commandContext.Channel);
            ...
            public async Task SendRandomMemeEmojiAsync(CommandContext commandContext) => await KWiJisho.Commands.CommandBasic.CommandRandomAnimatedMemeEmojiAsync(commandContext.Channel);
            ...
            public async Task SendRandomPartyEmojiAsync(CommandContext commandContext) => await KWiJisho.Commands.CommandBasic.CommandRandomAnimatedPartyEmojiAsync(commandContext.Channel);
        }
    }
}
