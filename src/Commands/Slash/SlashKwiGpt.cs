...
namespace KWiJisho.Commands.Slash
{
    ...
    /// </summary>
    public class SlashKwiGpt : ApplicationCommandModule
    {
        /// <summary>
        ...
        public static async Task ExecuteSlashKWiJishoPromptAsync(InteractionContext interactionContext, [Option("seu-texto", "Qualquer coisa! Manda um textinho que você quiser que eu responda <3")] string input)
        {
