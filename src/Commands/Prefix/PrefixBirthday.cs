...
namespace KWiJisho.Commands.Prefix
{
    ...
    internal partial class PrefixCommandManager
    {
        ...
        internal class PrefixBirthday : BaseCommandModule
        {
            ...
            internal async Task GetNextBirthdayAsync(CommandContext commandContext) => await KWiJisho.Commands.Birthday.GetNextBirthdayAsync(commandContext.Channel, commandContext.Guild);
            ...
            internal async Task GetListBirthdayAsync(CommandContext commandContext) => await KWiJisho.Commands.Birthday.GetListBirthdayAsync(commandContext.Channel, commandContext.Guild);
        }
    }
}
